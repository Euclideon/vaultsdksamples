...
namespace Vault
{
  ...
  public class vdkContext
  {
    ...
    public void Reconnect(string pURL, string pApplicationName, string pUsername, bool tryDongle) {
...
class ErrorHandler{
    ...
    public static void handleError(string functionName, vdkError error)
    {
      string errStr = functionName + " failed: ";
      switch (error)
      {
        case vdkError.vE_Success:
          return;
        case vdkError.vE_InvalidParameter:
    ...
    public static void handleInvalidParameter(params string[] list) {
      string errorStr = "Invalid Parameter, passed parameters:";
