...
namespace Vault
{
    ...
    public struct vdkRenderPicking
    {
        ...
        public char hit;//true if voxel was hit by this pick
        public char isHighestLOD;//true if hit was as accurate as possible
    ...
    public class vdkRenderContext
    {
        ...
        public void Render(vdkRenderView renderView, vdkRenderInstance[] pModels, int modelCount, ref vdkRenderOptions options)
        {
            if (modelCount == 0)
                return;
            ...
            vdkError error = vdkRenderContext_Render(pRenderer, renderView.pRenderView, pModels, modelCount,  options);
    ...
    public class vdkRenderView
    {
        ...
        public void SetTargets(ref uint[] colorBuffer, UInt32 clearColor, ref float[] depthBuffer)
        {
            if (colorBufferHandle.IsAllocated)
                colorBufferHandle.Free();
